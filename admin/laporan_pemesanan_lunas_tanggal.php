...
<table class="table-list" width="850" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="117" align="right" bgcolor="#CCCCCC"><font color="#FF0066"><strong>Total   </strong></font></td>
    <td width="126" align="right" bgcolor="#CCCCCC"><font color="#FF0066"><strong>Total Keseluruhan (Rp) </strong></font></td></td>
  ...
  <?php
	...
	$mySql = "SELECT pemesanan.*, pelanggan.nm_pelanggan FROM pemesanan 
	...
	while ($myData = mysql_fetch_array($myQry)) {
		...
		// MENGHITUNG TOTAL BAYAR, TOTAL JUMLAH HOMESTAY dengan perintah SQL
		$my2Sql	= "SELECT SUM(harga * jumlah) As total_bayar,
					SUM(jumlah) As total_homestay 
		...
		$totItemhomestay	= $totItemhomestay + $my2Data['total_homestay'];
  ...
  <tr>
    ...
    <td align="right"><?php echo $my2Data['total_homestay']; ?></td>
  ...
  <tr>
    ...
    <td align="right" bgcolor="#CCCCCC"><strong><?php echo format_angka($totItemhomestay); ?></strong></td>
