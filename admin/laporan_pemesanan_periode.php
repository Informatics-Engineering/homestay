...
<table width="800" border="0" cellpadding="2" cellspacing="1" class="table-list" >
  <tr>
    ...
    <th width="12%" bgcolor="#CCCCCC"><font color="#FF0066"><b>Tanggal</b></font></th>
   ...
   <th width="32%" bgcolor="#CCCCCC"><font color="#FF0066"><strong>Nama Pelanggan </strong></font></th>
    <th width="13%" align="right" bgcolor="#CCCCCC"><font color="#FF0066">Total  </font></th>
  ...
  while ($myData =mysql_fetch_array($myQry)) {
	  ...
	  // Sub SQL menghitung total harga, dan total Homestay  yang dipesan
	  ...
	  $my2Data= mysql_fetch_array($my2Qry);
		...
		// Menghitung Total Bayar dari harga setelah diskon, dikali jumlah homestay
		
		$totalBayar 	= $my2Data['total_harga'] ;
