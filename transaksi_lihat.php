...
<table width="600" border="0" cellspacing="2" cellpadding="3">
  ...
  <tr>
    <td><strong>Booking Atas Nama</strong></td>
    <td><strong>:</strong></td>
...
<table width="761" border="0" cellpadding="2" cellspacing="0">
  <tr>
    ...
    <td width="324" bgcolor="#CCCCCC"><strong>Nama homestay </strong></td>
  ...
  <?php } 
  	// Menghitung
		...
		$totalBiayaKirim = $myData['biaya'] * $totalhomestay;
  ...
  <tr>
    <td colspan="5" align="right"><strong>Biaya Asuransi  (Rp) : </strong></td>
