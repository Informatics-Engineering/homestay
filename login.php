...
?>
  <form name="frmLogin" method="post" action="?open=Login-Validasi">
    <tr>
      <td height="22" align="center" bgcolor="#CCCCCC" class="head"><b><font color="040404">LOGIN PELANGGAN </font></b></td>
    </tr>
    <tr> 
      <td width="919" height="18"><b><font color="040404">Username : </font></b><br />
        <input name="txtUsername" type="text"  size="20" maxlength="30"> </td>
    </tr>
    <tr> 
      <td height="18"> <b><font color="040404">Password :</font></b> <br />
...
?>
  ...
  <tr> 
    <td><b> <img src="images/ikon.png" width="9" height="9"> <a href="?open=Keranjang-Belanja" target="_self">Keranjang Pemesanan </b></td>
  </tr>
  
  <tr> 
    <td><b> <img src="images/ikon.png" width="9" height="9"> <a href="?open=Transaksi-Tampil" target="_self">Riwayat Transaksi </a> </b></td>
  </tr>
  <tr>
