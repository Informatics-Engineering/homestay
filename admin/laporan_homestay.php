...
?>
<h2><font color="#FF0066"> LAPORAN DATA HOMESTAY </font></h2>
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table  class="table-list"  width="400" border="0" cellpadding="2" cellspacing="1">
    <tr>
      <th colspan="2" bgcolor="#CCCCCC"><font color="#FF0066"><strong>KATEGORI HOMESTAY </strong></font></th>
    </tr>
    <tr>
...
<table class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="470" bgcolor="#CCCCCC"><font color="#FF0066"><strong>Nama homestay </strong></font></td>
    <td width="34" align="center" bgcolor="#CCCCCC"><font color="#FF0066"><strong> Stok</strong></font></td>
    <td width="90" align="right" bgcolor="#CCCCCC"><font color="#FF0066"><strong>(Rp) Promo</strong></font></td>
    <td width="82" align="right" bgcolor="#CCCCCC"><font color="#FF0066"><strong>(Rp) Normal</strong></font></td>
  </tr>
  <?php	
	$mySql = "SELECT * FROM homestay $filterSql ORDER BY kd_homestay ASC LIMIT $hal, $baris";
  ...
  <tr>
    ...
    <td align="center"><?php echo $myData['kd_homestay']; ?></td>
    <td><?php echo $myData['nm_homestay']; ?></td>
    <td align="center"><?php echo $myData['stok']; ?></td>
    <td align="right"><?php echo format_angka($myData['harga_promo']); ?></td>
  ...
  <tr class="selKecil">
	...
	for ($h = 1; $h <= $maksData; $h++) {
		...
		echo " <a href='?open=Laporan-homestay&hal=$list[$h]&kodeKat=$dataKategori'>$h</a> ";
	}
	?></td>
  </tr>
</table>
