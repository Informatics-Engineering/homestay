...
if(isset($_GET['open'])) {
	switch ($_GET['open']){	
		default			: if(!file_exists ("homestay.php")) die ("File homestay tidak ada"); 
								include "homestay.php"; break;

		case '' 		: if(!file_exists ("homestay.php")) die ("File homestay tidak ada"); 
								include "homestay.php"; break;
		...
		case 'homestay' 		: if(!file_exists ("homestay.php")) die ("File homestay tidak ada"); 
								include "homestay.php"; break;
																
		case 'homestay-Lihat' :if(!file_exists ("homestay_lihat.php")) die ("File homestay tidak ada"); 
								include "homestay_lihat.php"; break;

		case 'homestay-Pencarian' :if(!file_exists ("homestay_pencarian.php")) die ("File cari homestay tidak ada"); 
								include "homestay_pencarian.php"; break;
								
		case 'homestay-Beli' :if(!file_exists ("homestay_beli.php"))  die ("File beli pilih sim tidak ada"); 
								include "homestay_beli.php"; break;

		case 'homestay-Kategori' :if(!file_exists ("homestay_kategori.php")) die ("File program tidak ada"); 
								include "homestay_kategori.php"; break;
	...
	if(!file_exists ("homestay.php")) die ("File homestay tidak ada"); 
