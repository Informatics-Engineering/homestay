...
<table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
  ...
  <tr bgcolor="#dfe9ff"> 
    ...
    <td width="14%" bgcolor="#F5F5F5"><strong>Nama  </strong></td>
    <td width="15%" align="right" bgcolor="#F5F5F5"><strong>Total   (Rp)</strong></td>
     <td width="15%" align="center" bgcolor="#F5F5F5"><strong>Status Bayar</strong></td>
  ...
  while ($myData =mysql_fetch_array($myQry)) {
    ...
    <tr> 
      ...
      <td bgcolor="#FFFFFF"><?php echo $myData['nama_pemesan']; ?></td>
