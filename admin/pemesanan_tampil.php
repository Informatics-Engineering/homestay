...
?>
<h1><b><font color="#080fa5">DAFTAR PEMESANAN </font></b></h1>
...
<table width="850" border="0" cellpadding="2" cellspacing="1" class="table-list" >
  ...
  while ($myData =mysql_fetch_array($myQry)) {
	  ...
	  $my2Sql	= "SELECT SUM(harga * jumlah) As total_bayar,
	  				SUM(jumlah) As total_homestay FROM pemesanan_item WHERE no_pemesanan='$Kode'";
	  ...
	  $my2Data 	= mysql_fetch_array($my2Qry);
		...
		$totalBayar = $my2Data['total_bayar'] * $my2Data['total_homestay'];
